...
export default function LoginPage() {
  ...
  // Obtener el destino original (para redireccionar después del login)
  ...
  useEffect(() => {
    ...
    const checkSession = async () => {
      try {
        ...
        if (session) {
          // Ya hay sesión, redirigir al destino
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-2xl p-8 shadow-2xl">
            ...
            {authRequired ? (
              <>
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Intentaste acceder a: <span className="text-emerald-400 font-mono">{returnTo}</span>
                </p>
              </>
            ) : (
              <>
                ...
                <p className="text-gray-400 mb-6">
                  Accede a tu cuenta de TarantulaHawk
                </p>
              </>
            )}
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-6 text-center">
              <a
                href="/"
                className="text-sm text-gray-400 hover:text-emerald-400 transition inline-flex items-center gap-1"
              >
          ...
          <div className="mt-8 pt-6 border-t border-gray-700">
            <div className="flex items-start gap-3 text-xs text-gray-500">
              ...
              <p>
                <strong className="text-gray-400">Seguridad sin contraseñas:</strong> Usamos Magic Links enviados por email. Sin contraseñas = sin riesgo de phishing o filtración.
              </p>
            </div>
          </div>
        </div>
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          TarantulaHawk © 2025 • Cumplimiento LFPIORPI
        </p>
      </div>
